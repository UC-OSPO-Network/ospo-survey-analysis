...
more_than_mod$importance_area <- gsub("Professional Development", "Professional development", more_than_mod$importance_area)
```
...
```{r}
ggsave(
  filename = file.path(FIGURE_PATH, "fig3.tif"),
  plot = p,
  device = "tiff",
