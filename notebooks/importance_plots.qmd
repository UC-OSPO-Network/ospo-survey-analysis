...
- Arguments:
  - `df`: A data frame with a column named 'importance_level'. Should contain only rows that you want to count. Extra columns is okay.
- Details:
...
Finally, let's check what percentage of teachers said OS is more than moderately important for their teaching.
```{r}
...
Finally, let's check what percentage of researchers said OS is more than moderately important for their research.
```{r}
