...
more_than_mod <- rbind(
  ...
  list(
    "Teachers",
    "Learning",
    get_percent_more_than_moderate(teachers_learning)[3]
  )
)
...
more_than_mod <- rbind(
  ...
  list(
    "Teachers",
    "Professional Development",
    get_percent_more_than_moderate(teachers_pd)[3]
  )
)
more_than_mod
```
...
more_than_mod <- rbind(
  ...
  list(
    "Researchers",
    "Learning",
    get_percent_more_than_moderate(researchers_learning)[3]
  )
)
...
more_than_mod <- rbind(
  ...
  list(
    "Researchers",
    "Professional Development",
    get_percent_more_than_moderate(researchers_pd)[3]
  )
)
more_than_mod
```
...
more_than_mod <- rbind(
  ...
  list(
    "Non-research Staff",
    "Learning",
    get_percent_more_than_moderate(nrstaff_learning)[3]
  )
)
...
more_than_mod <- rbind(
  ...
  list(
    "Non-research Staff",
    "Professional Development",
    get_percent_more_than_moderate(nrstaff_pd)[3]
  )
)
```
...
more_than_mod <- rbind(
  ...
  list(
    "Students",
    "Learning",
    get_percent_more_than_moderate(students_learning)[3]
  )
)
...
more_than_mod <- rbind(
  ...
  list(
    "Students",
    "Professional Development",
    get_percent_more_than_moderate(students_pd)[3]
  )
)
...
```{r}
res_teachers_teaching
res_researchers_research
res_staff_job
```
