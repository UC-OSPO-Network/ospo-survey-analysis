...
Unfortunately, this function does not give estimates or confidence intervals. If a reviewer asks for these, I think we can calculate them using the prop.test function in a pairwise manner with correction.
