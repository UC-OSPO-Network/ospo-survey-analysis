...
write_df_to_file(summary_df_to_print, "supplementary_tables/challenges.tsv")
```
...
Save the data for tweaking the final figure. NOTE CLUSTER NAME CHANGE.

```{r}
write_df_to_file(data_cluster1, "data_for_plots/chall_cluster3.tsv")
write_df_to_file(data_cluster3, "data_for_plots/chall_cluster2.tsv")
write_df_to_file(data_cluster2, "data_for_plots/chall_cluster1.tsv")
```
...
Tried plotting horizontally a couple different ways. Sticking with the vertical version.
