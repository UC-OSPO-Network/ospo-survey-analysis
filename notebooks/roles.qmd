...
job_maint_to_plot$job_category <- factor(job_maint_to_plot$job_category, levels = ordered_jobs)
...
```{r}
svglite::svglite(file.path(FIGURE_PATH, "figure4.svg"), width = 16, height = 8); print(p_combined); dev.off()
```
