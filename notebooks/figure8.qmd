...
clust1$challenge_level <- factor(
  clust1$challenge_level,
  levels = level_order)

clust2$challenge_level <- factor(
  clust2$challenge_level,
  levels = level_order)

clust3$challenge_level <- factor(
  clust3$challenge_level,
  levels = level_order)
```
