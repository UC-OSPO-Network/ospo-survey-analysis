...
emm$job_category <- gsub("Non-research Staff", "Non-research staff", emm$job_category)
emm$job_category <- gsub("Postdocs and Staff Researchers", "Postdocs and staff researchers", emm$job_category)
```
...
# errors bars, so they'll the the bottom layer on the plot
  ...
  scale_color_manual(values = c(COLORS[2], COLORS[1], COLORS[3], COLORS[4]))+
